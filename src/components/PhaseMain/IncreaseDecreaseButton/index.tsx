    ...
    render() {
        return (
            <div className={style.IncreaseDecreaseButton__container} style={{width:this.props.width}}>
                <div className={style.IncreaseDecreaseButton__increaseButton} onClick={() => this.props.onIncrease()}>
                   <img src={increaseIcon} alt="^" />
                </div>
                <div className={style.IncreaseDecreaseButton__decreaseButton} onClick={() => this.props.onDecrease()}>
